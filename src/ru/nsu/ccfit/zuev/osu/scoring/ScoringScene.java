...
public class ScoringScene {
    ...
    public void load(final StatisticV2 stat, final TrackInfo track,
        ...
        final Rectangle bgTopRect = new Rectangle(0, 0, Config.getRES_WIDTH(), Utils.toRes(100), (VertexBufferObjectManager) null);
        ...
        final Sprite panel = new Sprite(x, y, Utils.toRes(panelr.getWidth() * 0.9f),
                Utils.toRes(panelr.getHeight() * 0.9f), panelr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit300s = new Sprite(Utils.toRes(10), Utils.toRes(130),
                Utils.toRes(hit300sr.getWidth()), Utils.toRes(hit300sr.getHeight()), hit300sr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit100s = new Sprite(Utils.toRes(10), Utils.toRes(130 + 92),
                Utils.toRes(hit100sr.getWidth()), Utils.toRes(hit100sr.getHeight()), hit100sr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit50s = new Sprite(0, Utils.toRes(120 + 92 * 2),
                Utils.toRes(hit50sr.getWidth()), Utils.toRes(hit50sr.getHeight()), hit50sr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit300ks = new Sprite(Utils.toRes(300), Utils.toRes(100),
                Utils.toRes(hit300ksr.getWidth()), Utils.toRes(hit300ksr.getHeight()), hit300ksr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit100ks = new Sprite(Utils.toRes(300), Utils.toRes(120 + 92),
                Utils.toRes(hit100ksr.getWidth()), Utils.toRes(hit100ksr.getHeight()), hit100ksr, (VertexBufferObjectManager) null);
        ...
        final Sprite hit0s = new Sprite(Utils.toRes(300), Utils.toRes(120 + 92 * 2),
                Utils.toRes(hit0sr.getWidth()), Utils.toRes(hit0sr.getHeight()), hit0sr, (VertexBufferObjectManager) null);
        ...
        final Sprite rankingText = new Sprite(Utils.toRes(580), 0,
                ResourceManager.getInstance().getTexture("ranking-title"), (VertexBufferObjectManager) null);
        ...
        final Sprite maxComboText = new Sprite(Utils.toRes(20 + x),
                ...
                "ranking-maxcombo"), (VertexBufferObjectManager) null);
        scene.attachChild(maxComboText);
        final Sprite accText = new Sprite(Utils.toRes(260 + x), Utils.toRes(332 + y),
                ResourceManager.getInstance().getTexture("ranking-accuracy"), (VertexBufferObjectManager) null);
        ...
        final Sprite mark = new Sprite(Utils.toRes(610), 0, ResourceManager
                .getInstance().getTexture("ranking-" + stat.getMark()), (VertexBufferObjectManager) null);
        if (track != null) {
            mark.setAlpha(0);
            mark.setScale(1.5f);
        ...
        final Sprite backBtn = new Sprite(Utils.toRes(580), Utils.toRes(490),
                ResourceManager.getInstance().getTexture("ranking-back"), (VertexBufferObjectManager) null) {
        ...
        {
            retryBtn = new Sprite(Utils.toRes(580), Utils.toRes(400), ResourceManager.getInstance().getTexture("ranking-retry"), (VertexBufferObjectManager) null) {
        ...
        if (!Multiplayer.isMultiplayer)
        {
            replayBtn = new Sprite(Utils.toRes(580), Utils.toRes(400),
                ResourceManager.getInstance().getTexture("ranking-replay"), (VertexBufferObjectManager) null) {
        ...
        if (stat.accuracy == 1 || stat.getMaxCombo() == this.track.getMaxCombo() || stat.isPerfect()) {
            final Sprite perfect = new Sprite(0, 0, ResourceManager
                    .getInstance().getTexture("ranking-perfect"), (VertexBufferObjectManager) null);
        ...
        if (stat.getMod().contains(GameMod.MOD_SCOREV2)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-scorev2"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        if (stat.getMod().contains(GameMod.MOD_HARDROCK)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-hardrock"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_EASY)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-easy"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        ...
        if (stat.getMod().contains(GameMod.MOD_HIDDEN)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-hidden"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        ...
        if (stat.getMod().contains(GameMod.MOD_FLASHLIGHT)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-flashlight"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        if (stat.getMod().contains(GameMod.MOD_NOFAIL)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-nofail"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_SUDDENDEATH)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-suddendeath"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_PERFECT)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-perfect"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        if (stat.getMod().contains(GameMod.MOD_AUTO)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-autoplay"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_AUTOPILOT)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-relax2"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_RELAX)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-relax"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        if (stat.getMod().contains(GameMod.MOD_DOUBLETIME)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-doubletime"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_NIGHTCORE)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-nightcore"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        } else if (stat.getMod().contains(GameMod.MOD_HALFTIME)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-halftime"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        ...
        if (stat.getMod().contains(GameMod.MOD_PRECISE)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-precise"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        //new mods in 1.6.8
        if (stat.getMod().contains(GameMod.MOD_REALLYEASY)) {
            final Sprite modSprite = new Sprite(modX, modY, ResourceManager
                    .getInstance().getTexture("selection-mod-reallyeasy"), (VertexBufferObjectManager) null);
            modX -= Utils.toRes(30);
            scene.attachChild(modSprite);
        }
        ...
        if (Config.isDisplayScoreStatistics()){
            ...
            final Text ppInfo = new Text(Utils.toRes(4), Config.getRES_HEIGHT() - playerInfo.getHeight() - Utils.toRes(2),
                    ResourceManager.getInstance().getFont("smallFont"), ppinfo.toString(), null);
            ppInfo.setPosition(Utils.toRes(244), Config.getRES_HEIGHT() - ppInfo.getHeight() - Utils.toRes(2));
            final Rectangle statisticRectangle = new Rectangle(Utils.toRes(240), Config.getRES_HEIGHT() - ppInfo.getHeight() - Utils.toRes(4), ppInfo.getWidth() + Utils.toRes(12), ppInfo.getHeight() + Utils.toRes(4), (VertexBufferObjectManager) null);

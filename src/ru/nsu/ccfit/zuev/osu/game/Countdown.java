...
public class Countdown extends GameObject {
    ...
    public Countdown(
        ...
        ready.registerEntityModifier(new SequenceEntityModifier(new ParallelEntityModifier(new FadeInModifier(COUNTDOWN_LENGTH * speed / 9),
            ...
            new DelayModifier(COUNTDOWN_LENGTH * speed / 9),
            new ParallelEntityModifier(new FadeOutModifier(COUNTDOWN_LENGTH * speed / 9), new ScaleModifier(COUNTDOWN_LENGTH * speed / 9, 1, 1.5f))));
        ...
        count3.registerEntityModifier(new SequenceEntityModifier(new FadeInModifier(COUNTDOWN_LENGTH * speed / 18),
        ...
        count2.registerEntityModifier(new SequenceEntityModifier(new FadeInModifier(COUNTDOWN_LENGTH * speed / 18),
        ...
        count1.registerEntityModifier(new SequenceEntityModifier(new FadeInModifier(COUNTDOWN_LENGTH * speed / 18),
        ...
        go.registerEntityModifier(new SequenceEntityModifier(new ParallelEntityModifier(new FadeInModifier(COUNTDOWN_LENGTH * speed / 18),
            new RotationModifier(COUNTDOWN_LENGTH * speed / 18, -180, 0)), new DelayModifier(COUNTDOWN_LENGTH * speed / 18), new FadeOutModifier(COUNTDOWN_LENGTH * speed / 18)));
        go.setRotation(-180);
        go.setVisible(false);

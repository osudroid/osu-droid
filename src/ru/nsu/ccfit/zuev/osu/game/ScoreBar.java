...
public class ScoreBar extends GameObject {
    ...
    public ScoreBar(
        final GameObjectListener listener, final Scene scene, final StatisticV2 stat) {
        this.stat = stat;
        ...
        if (ResourceManager.getInstance().isTextureLoaded("scorebar-colour-0")) {
            ...
            colour = new AnimSprite(Utils.toRes(5), Utils.toRes(16), loadedScoreBarTextures.size(), loadedScoreBarTextures.toArray(new String[loadedScoreBarTextures.size()]));
        } else {
            colour = new Sprite(Utils.toRes(5), Utils.toRes(16), ResourceManager.getInstance().getTexture("scorebar-colour"));
        }
        ...
        ki.setPosition(Utils.toRes(5) + colour.getWidth() - ki.getWidth() / 2, Utils.toRes(16) + colour.getHeight() / 2 - Utils.toRes(58));

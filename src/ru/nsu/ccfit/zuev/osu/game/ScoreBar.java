...
public class ScoreBar extends GameObject {
    ...
    public ScoreBar(
        final Scene scene, final StatisticV2 stat) {
        this.stat = stat;
        ...
        if (ResourceManager.getInstance().isTextureLoaded("scorebar-colour-0")) {
            ...
            colour = new AnimSprite(Utils.toRes(5), Utils.toRes(16), loadedScoreBarTextures.size(), loadedScoreBarTextures.toArray(new String[0]));
        } else {

...
public class SongMenu implements IUpdateHandler, MenuItemListener,
    ...
    public void onUpdate(final float pSecondsElapsed) {
        ...
        if (Math.abs(velocityY) > 1000 * pSecondsElapsed) {
            velocityY -= 1000 * pSecondsElapsed

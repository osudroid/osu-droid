...
public class QualityFileBitmapSource extends BaseTextureAtlasSource implements IBitmapTextureAtlasSource {
    ...
    public QualityFileBitmapSource(
        final File pFile, final int pTexturePositionX, final int pTexturePositionY) {
        this(() -> new FileInputStream(pFile), pTexturePositionX, pTexturePositionY, 1);
    }

    public QualityFileBitmapSource(
        final InputFactory pFile, final int pTexturePositionX, final int pTexturePositionY, int inSampleSize) {
    ...
    QualityFileBitmapSource(
        final InputFactory pFile, final int pTexturePositionX, final int pTexturePositionY, final int pWidth, final int pHeight) {
        super(pTexturePositionX, pTexturePositionY);
        fileBitmapInput = pFile;
        this.mWidth = pWidth;

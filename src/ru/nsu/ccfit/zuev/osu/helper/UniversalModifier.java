...
public class UniversalModifier extends SingleValueSpanEntityModifier {
    ...
    public UniversalModifier(final float duration, final float from, final float to, final ValueType type) {
    ...
    public void init(final float duration, final float from, final float to, final ValueType type) {
        reset();
        mDuration = duration;
        mFromValue = from;
        mValueSpan = to - from;

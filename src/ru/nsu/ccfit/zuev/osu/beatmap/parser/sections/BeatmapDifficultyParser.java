...
public class BeatmapDifficultyParser extends BeatmapKeyValueSectionParser {
    ...
    public void parse(BeatmapData data, String line) {
        ...
        switch (p[0]) {
            case "CircleSize" -> data.difficulty.cs = parseFloat(p[1]);
            ...
            case "ApproachRate" -> data.difficulty.ar = parseFloat(p[1]);
            case "HPDrainRate" -> data.difficulty.hp = parseFloat(p[1]);

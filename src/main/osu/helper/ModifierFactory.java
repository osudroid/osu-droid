...
public class ModifierFactory {
    ...
    public static IEntityModifier newFadeInModifier(final float duration) {
        return instance.newModifier(duration, 0, 1, UniversalModifier.ValueType.ALPHA);
    }

    public static IEntityModifier newFadeOutModifier(final float duration) {
        return instance.newModifier(duration, 1, 0, UniversalModifier.ValueType.ALPHA);
    }

    public static IEntityModifier newAlphaModifier(final float duration,
                                                   final float from, final float to) {
        return instance.newModifier(duration, from, to, UniversalModifier.ValueType.ALPHA);
    }

    public static IEntityModifier newScaleModifier(final float duration,
                                                   final float from, final float to) {
        return instance.newModifier(duration, from, to, UniversalModifier.ValueType.SCALE);
    }

    public static IEntityModifier newDelayModifier(final float duration) {
        return instance.newModifier(duration, 0, 0, UniversalModifier.ValueType.NONE);
    }
    ...
    private UniversalModifier newModifier(final float duration,
                                          final float from, final float to, final UniversalModifier.ValueType type) {

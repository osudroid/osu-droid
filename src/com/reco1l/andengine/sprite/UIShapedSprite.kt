...
class UIShapedSprite : UISprite() {
    ...
    companion object {
        ...
        private val SHAPE_DEPTH_INFO = DepthInfo(test = true, mask = true, function = GLES32.GL_ALWAYS)
        private val SPRITE_DEPTH_INFO = DepthInfo(test = true, mask = true, function = GLES32.GL_EQUAL)

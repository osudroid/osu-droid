...
class DroidDifficultyHitObject(
    ...
    override val overallDifficulty: Double
        get() {
            val greatWindow = fullGreatWindow / 2

            return if (hitWindow is PreciseDroidHitWindow) {
                PreciseDroidHitWindow.hitWindow300ToOverallDifficulty(greatWindow)
            } else {
                DroidHitWindow.hitWindow300ToOverallDifficulty(greatWindow)
            }
        }

    ...
    protected void onStart() {
        ...
        if (getIntent().getData() != null) {
            ...
            try {
                ...
                File rep = new File(Config.getScorePath(), entry.score.getReplayPath());
                if (!rep.exists()) {
                ...
                outputStream.close();
                entry.score.setReplayPath(rep.getAbsolutePath());
                if (DatabaseManager.getScoreTable().insertScore(entry.score) > 0) {

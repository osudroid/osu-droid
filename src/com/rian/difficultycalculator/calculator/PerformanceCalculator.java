...
public class PerformanceCalculator {
    ...
    private PerformanceAttributes createPerformanceAttributes() {
        ...
        if (difficultyAttributes.mods.contains(GameMod.MOD_RELAX)) {
            ...
            double okMultiplier = Math.max(0, difficultyAttributes.overallDifficulty > 0 ? 1 - Math.pow(difficultyAttributes.overallDifficulty / 0.5, 1.8) : 1);
            double mehMultiplier = Math.max(0, difficultyAttributes.overallDifficulty > 0 ? 1 - Math.pow(difficultyAttributes.overallDifficulty / 0.5, 5) : 1);

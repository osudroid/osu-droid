...
object Interpolation {
     ...
     */
    @JvmStatic
    fun damp(start: Double, end: Double, base: Double, exponent: Double): Double {
        if (base < 0 || base > 1) {
            throw IllegalArgumentException("Base must be in the range [0, 1].")
        }
     ...
     */
    @JvmStatic
    fun dampContinuously(current: Double, target: Double, halfTime: Double, elapsedTime: Double) =

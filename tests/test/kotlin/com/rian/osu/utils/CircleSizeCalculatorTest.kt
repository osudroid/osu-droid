...
class CircleSizeCalculatorTest {
    ...
    fun `Test osu!droid circle size to old osu!droid difficulty scale conversion`() {
        ...
        test(6f, 0.83595f)
        test(8f, 0.69595003f)
        test(10f, 0.55595005f)
        test(12f, 0.41594997f)
        test(14f, 0.27594998f)
        test(16f, 0.13595f)
        test(17f, 0.06594995f)
        test(18f, 0.001f)
        test(19f, 0.001f)
        test(20f, 0.001f)
    }
    ...
    fun `Test old osu!droid difficulty scale to osu!droid circle size conversion`() {
        ...
        test(0.83595f, 6f)
        test(0.69595003f, 8f)
        test(0.55595005f, 10f)
        test(0.41594997f, 12f)
        test(0.27594998f, 14f)
        test(0.13595f, 16f)
        test(0.06594995f, 17f)
        test(0.001f, 17.927858f)
    }

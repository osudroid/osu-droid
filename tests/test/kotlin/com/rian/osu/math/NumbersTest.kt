...
class NumbersTest {
    ...
    fun `Test float precise rounding`() {
        ...
        test(0.123f, 0.123456789f, 3)
        test(0.1235f, 0.123456789f, 4)
        test(0.12346f, 0.123456789f, 5)
        test(0.123457f, 0.123456789f, 6)
        test(0.1234568f, 0.123456789f, 7)
        test(0.12345679f, 0.123456789f, 8)
        test(0.123456789f, 0.123456789f, 9)
    }
